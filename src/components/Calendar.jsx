...
function ScheduleCalendar(props){
    ...
    const [courseList, setCourseList] = useState(JSON.parse(localStorage.courses));
    ...
    <div className="coursesNotDisplayedTitleBox">
        ...
        <h3 className='notDisplayedTitle'>
                Courses Not Displayed
        </h3>
        <div className="coursesNotDisplayedBox">
            
            <Schedule allowButtons={false}
                      courseList={TBDCourseList} />
        </div>
    </div>) : "" }
    </>)
}
