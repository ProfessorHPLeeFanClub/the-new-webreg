...
import { fetchCourseCodeData, combineParsedCourses, parseCourseData } from "../api/fetchData";
...
//    }, [courseList]) //JSON.stringify(props.courseList), 
    ...
    return <>
        ...
        <div className="scheduleListSaved">
            ...
            {savedCourseList.length == 0 ? (<div className="emptySchedule">No Courses</div>) : savedCourseList.map((courseInfo) => {
